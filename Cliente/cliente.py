...
class Cliente():
    ...
    def __method(self):
        ...
        try:
            msg = ''
            while msg != '\x18':
                print("Digite a cota que deseja e o serviço que deseja(Exemplo 'PETR4.SA,TRADEABLE')")
                print("Os serviços disponíveis são: TRADEABLE, REGION, PRICEHINT, REGULARMARKETDAYRANGE")
                msg = input()
                if msg == '':
                    continue
                elif msg == 'x':
